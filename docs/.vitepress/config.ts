      ...
      '/skills/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '测序质量控制', link: '/skills/concepts/quality-control' },
            { text: '数据标准化与归一化', link: '/skills/concepts/normalization' },
            { text: '组成性数据分析 (CoDA)', link: '/skills/concepts/compositional-data-analysis' },
            { text: '批次效应', link: '/skills/concepts/batch-effects' },
            { text: '样本污染与去污染', link: '/skills/concepts/decontamination' },
            { text: '功能谱 vs 分类谱', link: '/skills/concepts/functional-vs-taxonomic' },
            { text: '宏转录组学', link: '/skills/concepts/metatranscriptomics' },
            { text: '微生物组网络分析', link: '/skills/concepts/network-analysis' },
            { text: '宏基因组组装基因组 (MAG)', link: '/skills/concepts/metagenome-assembled-genomes' },
            { text: '基因组解析宏基因组学', link: '/skills/concepts/genome-resolved-metagenomics' },
