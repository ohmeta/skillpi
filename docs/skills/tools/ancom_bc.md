...
- 📦 **代码仓库**: [https://github.com/frederick-huang-lin/ANCOMBC](https://github.com/frederick-huang-lin/ANCOMBC)
- 📄 **论文**: [https://doi.org/10.1038/s41467-020-17041-7](https://doi.org/10.1038/s41467-020-17041-7)

## 安装

```bash
conda install -c bioconda ancom-bc
```
