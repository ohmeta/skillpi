...
class TestTool:
    ...
    def test_create_tool(self):
        """测试创建工具"""
        tool = Tool(name="TestTool", description="A test tool", category="analysis")
...
class TestConcept:
    ...
    def test_create_concept(self):
        """测试创建概念"""
        concept = Concept(name="Test Concept", definition="A test concept")
...
class TestSkill:
    ...
    def test_create_skill_tool(self):
        """测试创建工具技能"""
        tool = Tool(name="TestTool", description="Test", category="analysis")
        skill = Skill(id="test-tool", type=SkillCategory.TOOL, data=tool)
    ...
    def test_create_skill_concept(self):
        """测试创建概念技能"""
        concept = Concept(name="Test Concept", definition="Test")
        skill = Skill(id="test-concept", type=SkillCategory.CONCEPT, data=concept)
...
class TestSkillCollection:
    ...
    def test_collection_with_skills(self):
        ...
        skill = Skill(id="test-tool", type=SkillCategory.TOOL, data=tool)
        collection = SkillCollection(
            name="Tools", description="Tool collection", skills=[skill]
        )
